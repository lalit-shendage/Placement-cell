...
module.exports.companyPage = async function (req, res) {
  try {
    ...
    return res.render('interviewlist', { students });
  } catch (error) {
...
module.exports.addinterview=async function(req, res){
  ...
  return res.render('addinterview',{student})
  
  }
  catch(error){
    console.log('Error in fetching add interview');
    return res.redirect('back');
  }
...
module.exports.scheduleInterview = async function (req, res) {
  ...
  console.log("interview scheduling initiated", id)
  try {
